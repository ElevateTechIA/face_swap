          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="border-t border-white/10 pt-4 sm:pt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {(['trending', 'editorial', 'new-year', 'cinematic', 'party', 'birthday', 'casual', 'professional', 'date', 'wedding', 'graduation', 'vacation', 'barber-shop', 'fade', 'beard', 'classic-cut', 'skin-fade', 'nails'] as Category[]).map((cat) => (
                  <button
                    key={cat}
                    type="button"
                  ...
                  >
                    {cat === 'new-year' ? 'New Year' : cat === 'barber-shop' ? 'Barber Shop' : cat === 'classic-cut' ? 'Classic Cut' : cat === 'skin-fade' ? 'Skin Fade' : cat.charAt(0).toUpperCase() + cat.slice(1)}
                  </button>
                ))}
              </div>
            </div>
