...
export type Category = 'trending' | 'editorial' | 'new-year' | 'cinematic' | 'party' | 'birthday' | 'casual' | 'professional' | 'date' | 'wedding' | 'graduation' | 'vacation' | 'barber-shop' | 'nails' | 'fade' | 'beard' | 'classic-cut' | 'skin-fade';
